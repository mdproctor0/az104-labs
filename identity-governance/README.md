...
| Lab | Domain | Status |
|---|---|---|
| [Identity & Governance]([./identity-governance](https://github.com/mdproctor0/az104-labs/tree/main/identity-governance)) | Entra ID · RBAC · Conditional Access · Azure Policy | ✅ Complete |
